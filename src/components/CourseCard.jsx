...
import AllCourcesImage from '../images/all-cources-card.jpg'
  ...
  return (
    ...
    <div class="grid rounded-3xl max-w-[370px]  shadow-sm bg-slate-100  flex-col">
      ...
      <div class="group p-2 grid z-10">
        ...
        <div >
          <span class="line-clamp-4 py-1 text-base text-left font-light leading-relaxed my-1.5">
        ...
        <div class=" grid-cols-2 flex group justify-between">
          <div class="font-black flex flex-col">
            <div class="flex items-center mx-2">
                <p class="ms-1 text-sm font-bold ">4.95</p>
                ...
                <p class="ms-1 text-sm font-medium text-gray-500 ">(11023)</p>
            </div>
          </div>
      </div>
      </div>
