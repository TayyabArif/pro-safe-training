    ...
    <div class="bg-gray-800 py-4 text-gray-400">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">prosafetraining</tspan>
                    </text>
                  </g>
                </g>
              </svg>
          ...
          <div class="px-2 my-4 w-1/4 ">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Blog</h2>
            </div>
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400">A Comprehensive Guide to Building Your First Aid Kit For Home</a></li>
              <li><a href="#" class="hover:text-blue-400">CPR and First Aid: Building Confidence through Expert Training</a></li>
              <li><a href="#" class="hover:text-blue-400"> Exciting News: ProSafe Training School Welcomes On The Go First Aid and First Aid Hero!</a></li>
              <li><a href="#" class="hover:text-blue-400">Taking Control in Critical Moments: Why First Aid Courses Are Essential</a></li>
              <li><a href="#" class="hover:text-blue-400">See More</a></li>
            </ul>
          </div>
          <div class="px-2 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
