...
import registerPoster from '../images/register.jpg'
  ...
  return (
    ...
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div class="hidden lg:block lg:w-1/2 bg-cover"
            style={{backgroundImage: `url(${registerPoster})`}}>
        </div>
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-[#3B73D0] text-center">Prosafetraining</h2>
            ...
            <div class="mt-8">
                <button class="bg-[#3B73D0] text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">Register</button>
            </div>
            <div class="mt-4 flex items-center justify-between">
